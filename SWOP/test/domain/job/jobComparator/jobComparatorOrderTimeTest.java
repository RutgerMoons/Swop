...
public class jobComparatorOrderTimeTest {

	@Test
	public void compareTest() {
		JobComparatorOrderTime j = new JobComparatorOrderTime();
		assertEquals(0, j.compare(null, null));
	}
	...
	public void compareToTestException() {
		...
		ImmutableClock ordertime2 = new ImmutableClock(2, 300);
		StandardOrder order2 = new StandardOrder("mario", model, 3, ordertime2);
		IJob job2 = new Job(order2);
		
		JobComparatorOrderTime d = new JobComparatorOrderTime();
		assertEquals(-1, d.compare(job, job2));
	}
